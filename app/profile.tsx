	...
	return (
		...
		<div className="flex flex-col sm:flex-row items-center mx-auto justify-between sm:space-x-8 mb-4">
			<header className="mb-4 sm:mb-0 text-center sm:text-left">
				...
				{/* LinkedIn Icon */}
				<a
					href="https://www.linkedin.com/in/lo-maxwell"
					target="_blank"
					rel="noopener noreferrer"
				...
				{/* <a
					...
					target="_blank"
					rel="noopener noreferrer"
					className="text-[#E4405F] hover:text-[#D62E55]"
				>
					<svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
				...
				{/* <a
					...
					target="_blank"
					rel="noopener noreferrer"
					className="text-[#1DA1F2] hover:text-[#0C85D0]"
				>
					<svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
				...
				<a
					...
					target="_blank"
					rel="noopener noreferrer"
					className="text-[#181717] hover:text-[#4078c0]"
				>
					<svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
